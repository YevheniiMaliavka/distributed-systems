 ...
 * 
 */
@WebServiceClient(name = "MyWebServiceImplService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:8080/app/services/MyWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYWEBSERVICEIMPLSERVICE_QNAME = new QName("http://ws/", "MyWebServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/app/services/MyWebService?wsdl");
    ...
    public MyWebService getMyWebServiceImplPort() {
        return super.getPort(new QName("http://ws/", "MyWebServiceImplPort"), MyWebService.class);
    }
    ...
    public MyWebService getMyWebServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "MyWebServiceImplPort"), MyWebService.class, features);
    }
